...
```json
{
  ...
  "allowed_scope": { "workspaces": ["/home/tony/projects/nexusOS"], "profiles": ["hermes-dev"] },
  "forbidden_actions": [
  ...
  "tests": [
    {"name": "lint", "command": "ruff check src", "workdir": "/home/tony/projects/nexusOS"},
    {"name": "unit", "command": "python -m pytest -q tests/", "workdir": "/home/tony/projects/nexusOS"}
  ],
  "review_requirements": {
    "required": true,
